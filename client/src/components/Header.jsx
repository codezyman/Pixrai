...
const Header = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center my-20">
      ...
      <h1 className="text-4x1 max-w-[300px] sm:text-7xl sm:max-w-[600px] mx-auto mt-10 text-center">
        Turn text to <span className="text-blue-600">image</span>, in seconds.
      </h1>

      <p className="text-center max-w-xl mx-auto ,t-5">
      ...
      <p className="mt-2 text-netural-600">Generated images from imagify</p>
    </div>
  );
};
